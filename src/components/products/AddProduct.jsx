...
export default function AddProduct({ onDone }) {
  ...
  const { actionLoading: creating } = useSelector(
  ...
  const toggleOffer = (variantId, sizeId) => {
    setVariants((prev) =>
      prev.map((variant) =>
          ...
          ? {
              ...
              sizes: variant.sizes.map((size) =>
                size.id === sizeId
                  ? {
                      ...size,
                      hasOffer: !size.hasOffer,
                      offerPrice: !size.hasOffer
                        ? size.offerPrice || 0
                        : 0,
                    }
                  : size
                    ...
                    <div className="flex items-center gap-3">
                      <div className="flex-1">
                        ...
                        <input
                          ...
                          className="w-full rounded-xl border border-border bg-card px-4 py-2.5 text-text outline-none focus:border-accent"
                        />
                      </div>
                      ...
                      {variants.length > 1 && (
                        <motion.button
                          ...
                          className="mt-5 flex h-9 w-9 shrink-0 items-center justify-center rounded-lg text-red-400 transition hover:bg-red-400/10"
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              <div>
                                ...
                                <input
                                  placeholder="Single / Medium / Family"
                                  value={size.size}
                                  onChange={(e) =>
                                    updateSizeField(
                                      variant.id,
                              ...
                              {size.hasOffer && (
                                ...
                                >
                                  <label className="mb-1.5 block text-xs font-medium text-accent">
                                    Offer Price
                                  </label>
                                  ...
                                  <input
                                    ...
                                    className="w-full rounded-lg border border-accent/40 bg-bg px-3 py-2 text-sm text-text outline-none focus:border-accent"
                                  />
                                </motion.div>
                              )}
                            </div>
